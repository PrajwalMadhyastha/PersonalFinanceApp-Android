...
// REFACTOR: Asynchronous & non-blocking ContentResolver operations using injected
// DispatcherProvider.io and application context retention to prevent leaks.
// =================================================================================
...
class SmsRepository(
     ...
     */
    override suspend fun getSmsDetailsById(lookupValue: Long): SmsMessage? =
        withContext(dispatcherProvider.io) {
